...
<body>   
    ...
    <div align=center; style="line-height=200%;">
        ...
        <h3 style="font-size: 15px;line-height: 20%;">por haber acreditado el curso</h3>
        <h2 class='nombre'>{{ $curso->nombre_curso  }}</h2>
        <h3 style="font-size: 14px;">Dentro del plan de becarios de UNICA, generación []</h3>
